...
export class ConfirmationModalComponent implements AfterViewInit {
  ...
  constructor(public confirmationService: ConfirmationService, private renderer: Renderer2) {}

  ngAfterViewInit(): void {
    setTimeout((): void => this.renderer.addClass(this.modal?.nativeElement, 'show'), 0);
  }
